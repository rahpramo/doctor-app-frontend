...
const HomePage = () => {
  ...
  const renderDoctorCard = useCallback((doctor) => {
    ...
    return (
      ...
      >
        <CardMedia
          ...
          alt={doctor.name}
          height="220"
          image={!hasImage || !doctor.avatar ? `${strapiMediaUrl}/upload_area_8bc1382fd8.png` : doctor.avatar?.url}
          sx={{ 
        ...
        <Container sx={{ py: 8 }}>
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            ...
            <Typography variant="h6" color="text.secondary" sx={{ maxWidth: 600, mx: 'auto', mb: 4 }}>
              Meet our experienced medical professionals dedicated to your health and well-being
            </Typography>
          </Box>
