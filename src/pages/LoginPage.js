...
const LoginPage = () => {
  ...
  const { displayRegistrationForm, setDisplayRegistrationForm } = useAppointments();
  ...
  const handleLogin = useCallback(async (data) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        dispatch(loginUser({ isAdmin:result.user.userType==='admin', email: result.user.email }));
  ...
  return (
    ...
    >
      <h1 id="login-page-title" style={{ visibility: "hidden", height: 0, margin: 0 }}>
